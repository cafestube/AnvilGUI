...
public class AnvilGUI {
    ...
    private AnvilGUI(
        ...
        this(plugin, player, mainThreadExecutor, LEGACY_SERIALIZER.deserialize(titleComponent),
                initialContents, preventClose, geyserCompatibility, interactableSlots, closeListener, concurrentClickHandlerExecution, clickHandler);
    }
    ...
    public static class Response {
         ...
         * @return An {@link Response} object for when the anvil GUI is to display text to the user
         */
        public static List<ResponseAction> text(Component text) {
            return Arrays.asList(ResponseAction.replaceInputText(text));
        }
